    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    Hear the Best Version of Yourself.
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    Transform the way you speak. MirrorVoice analyzes your speech, removes filler words, and plays back a clearer, more confident version of what you meant to say.
                                </TextEffect>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32 w-ful">
                    <div className='flex flex-row w-full justify-center space-x-4'>
                        <h1 className='text-2xl'>Built with</h1>
                        <Image
